...
public class BrCompiler/*@bgen(jjtree)*/implements BrCompilerTreeConstants, BrCompilerConstants {/*@bgen(jjtree)*/
  protected static JJTBrCompilerState jjtree = new JJTBrCompilerState();
...
public static int one_line() throws ParseException, ParseEOFException {
    try {
...
/* Adicione este import no PARSER_BEGIN se ainda não tiver */
// import recovery.*;
  static final public 
void main() throws ParseException, ParseEOFException {/*@bgen(jjtree) main */
